  ...
  return (
    <div className='bg-menu' >
      ...
      <div style={{backgroundColor:"#F5FFFA" ,borderRadius:'3px',boxShadow:"0px 2px 10px #D3D3D3"}}>
      {
        ...
        <div onClick={()=>(setDishes(category.dishes),setCategoryName(category.name))} style={{border:"1px solid lightGray",margin:'5px',borderRadius:'3px',pointerEvents:"fill"}}>
